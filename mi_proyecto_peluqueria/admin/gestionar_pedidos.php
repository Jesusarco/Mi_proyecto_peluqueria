...
<style>
    ...
    .btn-archivar { background: #e74c3c; color: white; padding: 5px 12px; border-radius: 4px; text-decoration: none; display: inline-block; font-size: 0.8rem; }
            ...
            <table class="salon-table">
                ...
                <tbody>
                    ...
                    <?php if (count($pedidos) == 0): ?>
                        <tr><td colspan="6" style="text-align:center;">No hay pedidos activos.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
