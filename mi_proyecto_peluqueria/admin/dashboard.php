...
<div class="dashboard-wrapper">
    ...
    <div class="content-area">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="../ajax/archivar.php?action=cita&id=<?= $c['id'] ?>" class="btn-completado" onclick="return confirm('¿Marcar cita como completada? Se ocultará del dashboard pero se conservará en la base de datos.')">Completar</a>
        ...
        <div id="tabla-usuarios" class="salon-card seccion-tabla">
            ...
            <table class="salon-table">
                <thead>
                    <tr><th>ID</th><th>Nombre</th><th>Email</th><th>Fecha registro</th>
                    <th>Acciones</th>
                </thead>
                <tbody>
...
<div id="overlayGasto" class="form-overlay">
    <div class="form-container">
        <h3>Nuevo gasto</h3>
        <form action="../ajax/crear_gasto.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label>Descripción *</label>
