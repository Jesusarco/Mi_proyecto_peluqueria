<?php
    ...
    // Determinar si el usuario está autenticado (para mostrar botones de carrito/reserva)
    $usuario_logueado = isset($_SESSION['usuario_id']);

    // ========== CONSULTAS A LA BASE DE DATOS ==========

    // Obtener todos los servicios (incluyendo imagen) ordenados por nombre
    ...
    // Obtener los 6 productos más destacados o los últimos (con stock > 0)
    ...
    // Obtener citas futuras (reservadas) para mostrar en la sección de reserva
...
<html lang="es">
    <head>
        ...
        <!-- Swiper CSS (carrusel táctil) -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
        
        <!-- Flatpickr CSS (selector de fecha) -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
        
        <!-- Google Fonts: Inter para textos, Playfair Display para títulos -->
    ...
    <body>
            ...
            <!-- Incluir el header común (con menú y carrito) -->
            <?php include "../includes/header.php"; ?>

            <!-- ========== CARRUSEL PRINCIPAL (HERO) ========== -->
            <div class="hero-slider swiper">
                <div class="swiper-wrapper">
                    <!-- Cada slide con imagen de fondo y texto superpuesto -->
                ...
                <!-- Paginación y botones de navegación del carrusel -->
                <div class="swiper-pagination"></div>
                <div class="swiper-button-next"></div>
                <div class="swiper-button-prev"></div>
            </div>

            <!-- ========== SECCIÓN "SOBRE NOSOTROS" ========== (siempre visible) -->
            <section id="sobre-nosotros" class="section">
                <div class="grid-2cols">
                    ...
                    <div class="about-text">
                        ...
                        <p>Utilizamos productos de alta gama y ofrecemos un trato personalizado porque cada cabello es único. Más de 15 años creando tendencia.</p>
                    </div>
                </div>
            </section>

            <!-- ========== SECCIÓN "SERVICIOS" (oculta inicialmente) ========== -->
            ...
            <!-- ========== SECCIÓN "PRODUCTOS" (oculta inicialmente) ========== -->
            ...
            <!-- ========== SECCIÓN "RESERVAR CITA" (oculta inicialmente) ========== -->
            <section id="cita" class="section seccion-oculta">
                ...
                <div class="cita-wrapper">
                    <?php if ($usuario_logueado): ?>
                        ...
                        <!-- Lista de citas ya ocupadas para referencia -->
            ...
            <section id="atencion-cliente" class="section">
                ...
                <div class="contacto-grid">
                    ...
                    <div style="font-size: 1.1rem; line-height: 1.5;">
                        ...
                        <br>
                        <p><strong><i class="bi bi-clock"></i> Horario</strong><br>Lunes-Viernes 09:00 – 13:30 | 16:00 – 20:30 <br> Sáb 09:00 – 13:30 | 16:00 – 20:30</p>
                    </div>
                ...
                <!-- Formulario de contacto de demostración (no funcional) -->
            ...
            <!-- ========== SCRIPTS ========== -->
            <script src="../assets/js/carrito.js"></script>          <!-- Funciones del carrito (addToCart, notificaciones) -->
            <script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script> <!-- Inicialización del carrusel -->
            <script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>                       <!-- Selector de fecha -->
            <script src="https://cdn.jsdelivr.net/npm/flatpickr/dist/l10n/es.js"></script>       <!-- Localización en español -->
            <script src="../assets/js/inicio.js"></script>                                       <!-- Lógica principal (filtros, reserva, scroll-up) -->
            
            <!-- Pasar variable PHP a JavaScript para saber si el usuario está logueado -->
            <script>
