<?php
    ...
    // Definir la página de inicio según el rol (dashboard para admin, inicio.php para clientes)
    $inicio = $esAdmin ? "../admin/dashboard.php" : "../user/inicio.php";

    // Variable que se pasa desde las páginas del dashboard para modificar el estilo del header
...
<html lang="es">
    <head>
        ...
        <!-- Swiper CSS (necesario para el carrusel de la portada, se carga en todas las páginas por simplicidad) -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
        
        <!-- Fuentes de Google: Cormorant Garamond para títulos, Jost para textos -->
        ...
        <style>
            /* ===== VARIABLES DE COLOR (tema elegante de peluquería) ===== */
            :root {
                --bg-cream: #F9F6F0;
                --text-dark: #2C2825;
                --text-muted: #6B625C;
            ...
            * { 
            ...
            /* Contenedor centrado para el contenido principal (no el dashboard) */
            .container {
                max-width: 1200px;
                margin: 0 auto;
                padding: 0 24px;
            ...
            /* ===== HEADER PARA EL FRONTEND (sticky, con desenfoque) ===== */
            <?php if (!$esDashboard): ?>
            ...
            /* Logotipo con tipografía elegante */
            .logo {
            ...
            /* Botones de la derecha (carrito y login/logout) */
            .header-actions { 
            ...
            /* Contador del carrito (se actualiza vía JS) */
            .cart-count {
                position: absolute;
                top: -8px;
                right: -12px;
            ...
            /* ===== HEADER PARA EL DASHBOARD (sin sticky, fondo oscuro) ===== */
            .salon-header {
                background: #1a1a1a;
            ...
            /* ===== ESTILOS GENERALES DEL FOOTER (se aplican en ambas versiones) ===== */
            .salon-footer {
            ...
            /* En móviles ocultar el menú de navegación principal (se puede reemplazar por menú hamburguesa) */
    ...
    <body>
        ...
        <!-- ===== HEADER FRONTEND (sticky, visible en todas las páginas de usuario) ===== -->
        <header class="main-header">
            <div class="container">
                <a href="../user/inicio.php" class="logo"><span>Áurea</span>Studio</a>
                <nav class="main-nav">
                    <!-- Los IDs coinciden con los usados en inicio.js para mostrar/ocultar secciones -->
                ...
                <div class="header-actions">
                    <!-- Icono del carrito que abre popup (JS) -->
        ...
        <!-- ===== HEADER DASHBOARD (sin sticky, fondo oscuro) ===== -->
        ...
        <!-- Contenedor principal: para el dashboard se usa ancho completo, para el frontend tiene márgenes -->
